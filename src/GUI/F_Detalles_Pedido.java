 ...
 * @author Farg-
 */
public class F_Detalles_Pedido extends javax.swing.JFrame {

    /**
     * Creates new form GUI_GUIA
     */
    public F_Detalles_Pedido() {
        initComponents();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(F_Detalles_Pedido.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new F_Detalles_Pedido().setVisible(true);
            }
        });
    }
