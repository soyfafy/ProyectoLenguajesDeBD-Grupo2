 ...
 * @author Farg-
 */
public class F_Pedidos extends javax.swing.JFrame {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(F_Pedidos.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
