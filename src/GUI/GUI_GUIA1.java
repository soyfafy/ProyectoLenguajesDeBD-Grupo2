 ...
 * @author Farg-
 */
public class GUI_GUIA1 extends javax.swing.JFrame {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(GUI_GUIA1.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
